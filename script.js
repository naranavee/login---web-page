/**
 * Variable to track the state of the message container (0 for login, 1 for register).
 */
var msg_count = 0;
...
/**
 * Function to display the password validation messages for login form.
 */
...
/**
 * Function to hide the password validation messages for login form.
 */
var valid = function () {
...
/**
 * Function to validate password strength for login form.
...
/**
 * Function to validate password strength for registration form.
 * Checks for lowercase, uppercase, numbers, and minimum length.
 */
...
/**
 * Function to compare password and confirm password fields for registration form.
